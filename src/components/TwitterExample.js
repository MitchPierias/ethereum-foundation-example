...
export default function(props) {
    return (
        <div className="twitter-example" style={{width:"100%",display:"flex",flexDirection:"row",border:"2px solid #EDEDED",borderRadius:"1vw",alignContent:"stretch",alignItems:"stretch",padding:"0.5vw 1vw"}}>
            ...
            <span style={{flex:"10 1",textAlign:"right"}}>
                <span style={{backgroundColor:"#EDEDED",height:"2vw",margin:"1vw 0.5vw",borderRadius:"2px"}}></span>
                <span style={{backgroundColor:"#EDEDED",height:"10vw",margin:"1vw 0.5vw",borderRadius:"2px"}}></span>
                {props.children}
            </span>
        </div>
    )
